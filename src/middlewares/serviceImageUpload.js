  ...
  upload.single('image')(req, res, (error) => {
    if (error) {
      if (error.code === 'LIMIT_FILE_SIZE') {
        return errorResponse(res, 'La imagen no puede superar los 5 MB', [], 413);
      }
      return errorResponse(res, 'Selecciona una imagen JPEG, PNG o WebP válida', [], 400);
    }
...
module.exports = { uploadServiceImage, MAX_IMAGE_SIZE_BYTES };
